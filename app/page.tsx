    ...
    <main className="relative min-h-screen overflow-hidden bg-[#09090D] text-white">
      ...
      <header className="relative z-10 mx-auto flex max-w-6xl items-center justify-between px-6 py-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#6C38FF] text-lg font-black shadow-[0_0_30px_rgba(108,56,255,0.35)]">F</div>
          <div>
        ...
        <nav className="flex items-center gap-3">
          <Link href={`/login${referralQuery}`} className="rounded-lg px-4 py-2.5 text-sm font-medium text-[#94A3B8] transition hover:text-white">Log in</Link>
          <Link href={`/register${referralQuery}`} className="rounded-lg bg-[#6C38FF] px-4 py-2.5 text-sm font-semibold shadow-[0_4px_20px_rgba(108,56,255,0.25)] transition hover:bg-[#5A2EE5]">Get started</Link>
        </nav>
      </header>
