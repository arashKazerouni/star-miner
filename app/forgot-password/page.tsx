    ...
    <main className="relative min-h-screen overflow-hidden bg-[#09090D] px-6 py-10 text-white">
      ...
      <div className="relative mx-auto flex min-h-[90vh] max-w-[440px] flex-col justify-center">
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit} className="rounded-2xl border border-[#22222D] bg-[#121217] p-6 space-y-5">
            <div>
            ...
            <button type="submit" disabled={loading} className="w-full rounded-lg bg-[#6C38FF] px-5 py-3.5 text-sm font-semibold disabled:opacity-50">{loading ? "Sending..." : "Send reset link"}</button>
          </form>
        )}
      </div>
    </main>
