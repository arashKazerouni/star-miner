      ...
      <div className="relative w-full max-w-[440px]">
        ...
        <div className="rounded-2xl border border-[#22222D] bg-[#121217] p-6 shadow-xl">
          <div className="mb-6 flex rounded-lg border border-[#22222D] bg-[#0F0F14] p-1 text-sm">
            ...
            <a
              href="/register"
              className="flex-1 px-3 py-2 text-center text-[#94A3B8]"
            >
              Create account
            </a>
          </div>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              disabled={loading}
              className="w-full rounded-lg bg-[#6C38FF] py-3.5 text-sm font-semibold shadow-[0_4px_20px_rgba(108,56,255,0.35)] transition hover:bg-[#5A2EE5] active:scale-[0.98] disabled:opacity-50"
            >
