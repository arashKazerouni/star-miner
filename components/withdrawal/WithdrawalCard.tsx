    ...
    <section className="mt-10">
      <div className="border-b border-zinc-900 pb-6">
        ...
        <p className="mt-2 font-mono text-3xl">
          {balance.toFixed(6)}
          <span className="ml-2 text-sm text-zinc-500">XLM</span>
        </p>
      </div>
      ...
      {available ? (
        <div className="rounded-2xl border border-zinc-800 p-5">
          <p className="text-sm text-white">Withdrawal unlocked</p>
        ...
        <div className="rounded-2xl border border-zinc-900 p-5">
          <p className="text-sm text-zinc-300">Withdrawal locked</p>
